...
void loadCalibration()
{
    ...
    else
    {
        ...
        mpu.setAccBias(0, -1402.71);
        mpu.setAccBias(1, 83.74);
        mpu.setAccBias(2, -632.81);
        mpu.setGyroBias(0, 5.49);
        mpu.setGyroBias(1, -1.08);
        mpu.setGyroBias(2, 3.00);
        mpu.setMagBias(0, 262.65);
        mpu.setMagBias(1, 1109.04);
        mpu.setMagBias(2, -465.19);
        mpu.setMagScale(0, 1.08);
        mpu.setMagScale(1, 1.00);
        mpu.setMagScale(2, 0.93);
    }
}
