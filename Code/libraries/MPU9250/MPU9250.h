...
public:
    ...
    float getMagCalibrationX() const { return magCalibration[0]; }
    float getMagCalibrationY() const { return magCalibration[1]; }
    float getMagCalibrationZ() const { return magCalibration[2]; }
